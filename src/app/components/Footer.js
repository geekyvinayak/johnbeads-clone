...
export default function Footer() {
  return (
    <footer className="bg-white border-t max-w-[1440px] w-full mx-auto">
      <div className="mx-auto md:p-12 p-6 gap-5 md:gap-0">
        <div className="flex justify-between flex-col md:flex-row">
          ...
          <div className="flex flex-1 max-w-3xl justify-between flex-col md:flex-row gap-5 md:gap-0">
          {/* Contact Us */}
          ...
          <div className="col-span-12 md:col-span-3">
            ...
            <form className="flex">
              ...
              <button
                type="submit"
                className="bg-[#05527C] text-white px-6 h-10 hover:bg-blue-800 text-sm"
              >
                JOIN
              </button>
            </form>
